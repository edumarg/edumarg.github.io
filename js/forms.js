...
function sendData() {
    ...
    urlEncodedDataPairs.push(
        encodeURIComponent("numberOfAbducted") +
        "=" +
        encodeURIComponent(form.querySelector("[name='numberOfAbducted']").value)
    );
    ...
    urlEncodedDataPairs.push(
        ...
        "=" +
        encodeURIComponent(form.querySelector("[name='request']").value)
    );
    urlEncodedDataPairs.push(
